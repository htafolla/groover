...
| GRVR token | `0x045B35480F289F8f83F53345A0f367875958957a` | v5 on-chain SVG; 16-hex + 64-hex DID; v4 `0xD892D683…` / v3 `0x6F955cA0…` superseded for new mints |
...
```json
{
  ...
  "services": [
    ...
    { "name": "GRVR", "endpoint": "eip155:8453:0x045B35480F289F8f83F53345A0f367875958957a/<grvrTokenId>", "version": "v1" }
  ],
  "x402Support": false,
  "active": true,
...
(`eip155:8453`, `0x045B3548…`); Sepolia proving uses `eip155:84532`, the §3 Sepolia
registry/contract.
