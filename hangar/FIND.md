...
| **CDP Bazaar** | Indexes the **shop URL** pinged (`url=`), never `/v1/ping`. Shop must unpaid-GET 402. | Ping `https://clearing.rippel.ai/v1/ping?url={shop}` after CDP keys. MCP 200 does not list. |
